...
public class GamePanel1 extends JPanel implements Runnable{
    ...
    public GamePanel1(){
        ...
        inst = new Instrucoes(LARGURA_TELA, ALTURA_TELA, 1);
    ...
    public void novosComandos(){
        ...
        bot = new Bot((LARGURA_TELA - LARGURA_COMANDO), MEIO_TELA, LARGURA_COMANDO, ALTURA_COMANDO, this);    
    }
